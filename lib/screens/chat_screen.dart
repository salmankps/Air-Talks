...
import 'package:air_talks/widgets/message_card.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  //for showing value of showing or hiding emoji
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    //progeress indicator for showing uploading
                    if (_isUploading)
                      const Align(
...
//app bar widget
  ...
  Widget _chatInput() {
    return Padding(
      ...
      child: Row(
        children: [
          //input field and control button
          Expanded(
            child: Card(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      ...
                      //uploading and image one by one
                      for (var i in images) {
